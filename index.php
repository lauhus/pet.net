...
<html lang="fr">
    ...
    <body>
        ...
        <div class="bloc3">
            <div class="mibloc1">
                <p>
        Pension pour Chats et Chiens<br>Rue des Animaux<br>57000 METZ France<br>Contactez-nous : <br>+33 0300000000 <br>pension.petnet@mail.fr</p>
            </div>
            <div class="mibloc2">
            <p>
            Ouvert 7 jours sur 7<br>De 09h00 à 18h00<br>Inscription sur place <br> avec rendez-vous<br>
            </p>
            </div>
            <div class="mibloc3">
            <p>
            Box individuel et spacieux avec chauffage <br>Parc extérieur de 600m²<br>Balade individuelle ou en groupe <br>Soigneur aux petits soins<br>
            </p>
            </div>
        </div>
